    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0d0d0f] px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-[#161618] border border-[#2a2a2c] rounded-xl p-6 space-y-5">
          <div>
            <h1 className="text-lg font-bold text-[#f0f0f0]">Crie sua conta</h1>
            <p className="text-sm text-[#6b6b72] mt-0.5">Comece a registrar suas sessões gratuitamente</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="name" className="text-xs font-medium text-[#6b6b72] uppercase tracking-wider">
                Nome de piloto
              </label>
              <input
                id="name"
          ...
          <p className="text-center text-xs text-[#6b6b72]">
            Já tem conta?{" "}
            <Link href="/login" className="text-[#f0f0f0] hover:text-[#e8612a] transition-colors">
              Entrar
            </Link>
          </p>
        </div>
